...
public class AzureWorkload {
	...
	@FindBy(xpath="//div/div/div/div/div/span[3]") WebElement pillar_Rel;
	@FindBy(xpath="//div/div/div/div/div/span[4]") WebElement pillar_Perf;
	@FindBy(xpath="//div/div/div/div/div/span[5]") WebElement pillar_Oper;
	...
	public AzureWorkload(WebDriver driver){
        this.driver = driver;
	...
	public void checkReviewTabBeforeReview(DataProvider dp) {
		...
		if(!"Security - 10".equals(pillar_Sec.getText().trim())) {
			Report.log("Default pillar and number of questions is not correct", Status.FAIL);
		}
		else if(!"Cost - 14".equals(pillar_Cost.getText().trim())) {
			Report.log("Default pillar and number of questions is not correct", Status.FAIL);
		}
		else if(!"Reliability - 5".equals(pillar_Rel.getText().trim())) {
			Report.log("Default pillar and number of questions is not correct", Status.FAIL);
		}
		else if(!"Performance - 4".equals(pillar_Perf.getText().trim())) {
			Report.log("Default pillar and number of questions is not correct", Status.FAIL);
		}
		else if(!"Operations - 6".equals(pillar_Oper.getText().trim())) {
			Report.log("Default pillar and number of questions is not correct", Status.FAIL);
		}
		else {
	...
	public void startReview(DataProvider dp) {
		...
		new AzureQues(driver).answerQues(dp);
	...
	public void checkReviewTabAfterReview(DataProvider dp) {
		...
		String cos=Integer.toString(14-j);
		...
		String perf=Integer.toString(4-j);
		...
		String sec=Integer.toString(10-j);
		...
		String rel=Integer.toString(5-j);
		...
		String ops=Integer.toString(6-j);
